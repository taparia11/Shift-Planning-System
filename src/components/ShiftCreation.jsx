...
function ShiftCreation () {
  ...
  const { availability, getAvailability, getEmployeeList,getEmployeeAvailabilityById } = context;
...
const [user,setUser]=useState('')
  ...
  const handleSubmit = async (e) => {
    ...
    if (hoursDifference >= 4) {
        ...
        const response = await fetch('http://localhost:5000/api/admin/shiftavailability', {
            method: 'POST',
            headers: {
...
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     const response = await fetch('http://192.168.1.13:5000/api/employee/availability', {
//         method: 'POST',
//         headers: {
//             'Content-Type': 'application/json',
//             'auth-token': localStorage.getItem('token')
